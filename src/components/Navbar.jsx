    ...
    <nav className="flex justify-between items-center h-20 px-4 absolute top-0 left-0 z-50 w-full text-white bg-transparent">
      ...
      <ul className="hidden md:flex space-x-6 pr-0 sm:pr-0 md:pr-0 lg:pr-20 xl:pr-40">
        ...
        >
          ...
          {dropdownIsShown && (
            <div className="absolute top-full left-1/2 transform -translate-x-[55%] z-40 bg-gray-200 text-gray-700 shadow-lg rounded-md w-screen max-w-xl px-4 py-4">
        ...
        <div className="md:hidden absolute z-10 top-0 left-0 w-full bg-gray-100/90 text-black px-4 py-6">
          ...
          <ul className="mb-4 space-y-4">
            ...
            >
              <span className="cursor-pointer">Destination</span>
              {dropdownIsShown && (
                <div className="absolute top-full left-1/2 transform -translate-x-1/2 z-40 bg-gray-200 text-gray-700 shadow-lg rounded-md w-screen max-w-2xl px-4 py-4">
